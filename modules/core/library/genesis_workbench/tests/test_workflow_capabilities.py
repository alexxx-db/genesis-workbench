...
def test_workflow_caps_from_catalog(monkeypatch):
    ...
    # Fail-open: this test is about catalog → Capability conversion, not the
    # Jobs API gate. Without the stub, workflow_capabilities() hits
    # WorkspaceClient().jobs.list() and hangs off-cluster.
